      ...
      <div className="space-y-6">
        ...
        {wizard.step === 1 && (
          <div className="bg-white border rounded-xl p-6">
            {wizard.source.id === 'csv' ? (
              <div>
                <h3 className="font-semibold text-gray-900 mb-4">Map your columns to DavenRoe fields</h3>
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mb-4">Choose the data types you want to bring into DavenRoe</p>
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white border rounded-xl p-5">
        ...
        <div className="space-y-2 text-sm text-gray-600">
          ...
          <p>2. <strong>Export all data.</strong> When importing from cloud platforms, select all data types. It's easier to have everything in DavenRoe than to go back for missing items.</p>
          ...
          <p>4. <strong>Run a trial balance.</strong> Compare the trial balance in DavenRoe with your source platform to verify the import is accurate.</p>
        </div>
      </div>
    </div>
  );
