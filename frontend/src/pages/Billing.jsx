...
const plans = [
  {
    ...
    features: [
      ...
      'Invoicing & payments',
      'AI categorisation',
      'Ask DavenRoe (natural language queries)',
...
const comparisonFeatures = [
  ...
  { name: 'Ask DavenRoe', practice: true, firm: true, enterprise: true },
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Contact our support team at billing@davenroe.com or reach out via the in-app chat.
          </p>
        </div>
        <button
          onClick={() => toast.warning('To cancel your subscription, please contact support at billing@davenroe.com')}
