  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        setBranding({ name: 'DavenRoe', logo_url: '/icon.svg', primary_color: '#4c6ef5', domain: '' });
      } finally {
        setLoading(false);
      }
    })();
        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none"
            />
            <p className="text-xs text-gray-400 mt-1">Point a CNAME record to app.davenroe.com to use your own domain.</p>
          </div>
        </div>
        ...
        <div className="bg-gray-100 rounded-xl p-6">
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            <div className="p-4 flex items-center gap-3" style={{ backgroundColor: branding.primary_color || '#4c6ef5' }}>
              ...
              <span className="text-white font-semibold">{branding.name || 'DavenRoe'}</span>
            </div>
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">Migrate data from other accounting platforms into DavenRoe.</p>
      </div>
