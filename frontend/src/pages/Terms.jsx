      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-16 py-16">
        ...
        <div className="space-y-10">
          ...
          <Section title="2. AI-Generated Output Disclaimer">
            ...
            <p>
              While AlecRae uses deterministic logic derived from published legislation for tax and payroll, the law is complex and subject to interpretation. AI outputs are probabilistic and may contain errors, omissions, or hallucinations. <strong>You are solely responsible for verifying all outputs before use.</strong>
            </p>
            <h3 className="font-semibold text-gray-900 mt-4 mb-2">2.3 Not a Substitute for Professional Advice</h3>
            <p>
              AlecRae does not replace a qualified accountant, registered tax agent, CPA, enrolled agent, payroll specialist, solicitor, or auditor. You must consult appropriately licensed professionals in your jurisdiction.
            </p>
          </Section>
          ...
          <Section title="5. Feature-Specific Terms">
            <div className="space-y-4">
              ...
              <FeatureTerms title="5.2 Payroll Module" items={[
                ...
                'Incorrect payroll may result in penalties or legal action. AlecRae accepts no liability.',
                'AlecRae does not lodge payroll returns or make super/pension/tax deposits on your behalf.',
              ]} />
              <FeatureTerms title="5.3 Tax Filing Module" items={[
                'Tax returns are drafts for professional review before lodgement.',
                'AlecRae does not guarantee acceptance by any tax authority.',
              ]} />
              ...
              <FeatureTerms title="5.6 Company Incorporation" items={[
                ...
                'AlecRae does not register companies with any government authority.',
              ]} />
              <FeatureTerms title="5.7 Expense Management" items={[
                'AI receipt scanning may contain errors. Review before approving.',
                'AlecRae does not validate the legitimacy of expense claims.',
              ]} />
            </div>
          </Section>
          ...
          <Section title="8. Indemnification">
            <p>
              You agree to indemnify and hold harmless AlecRae from any claims, damages, losses, and expenses arising from your use of the service, including claims from your employees, contractors, clients, or counterparties.
            </p>
          </Section>
          ...
          <div className="border-2 border-blue-200 rounded-2xl p-6 bg-blue-50/30">
            <Section title="10. United States — Supplemental Terms">
              ...
              <p className="mb-3">
                AlecRae is <strong>not</strong> a CPA, enrolled agent, registered tax preparer, licensed attorney, registered investment advisor, or any other licensed professional under US federal or state law. No professional relationship is created.
              </p>
              <p className="mb-1 font-semibold text-sm text-gray-800">AlecRae does not:</p>
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-3 text-xs text-red-700 mb-4">
                <strong>IRS Circular 230 Notice:</strong> AlecRae&apos;s outputs do not constitute a &ldquo;covered opinion&rdquo; or &ldquo;other written advice&rdquo; under Circular 230. You may not rely on AlecRae&apos;s outputs to avoid penalties under the Internal Revenue Code.
              </div>

              <h3 className="font-bold text-gray-900 mt-6 mb-3">10.3 US Dispute Resolution</h3>
              <p className="mb-3">
                Disputes governed by the Federal Arbitration Act (9 U.S.C. §§ 1-16). Binding individual arbitration via the American Arbitration Association (AAA). For claims under $10,000, AlecRae pays all AAA fees.
              </p>
              ...
              <p className="text-sm text-gray-500 mb-4">
                Opt-out: You may opt out of arbitration within 30 days of account creation by emailing legal@alecrae.com. If you opt out, disputes go to state or federal courts in Wilmington, Delaware.
              </p>

              <h3 className="font-bold text-gray-900 mt-6 mb-3">10.4 California (CCPA/CPRA)</h3>
              <p>
                AlecRae does <strong>not sell or share</strong> your personal information. See our <a href="/privacy" className="text-indigo-600 underline">Privacy Policy</a> for full CCPA/CPRA disclosures including your right to know, delete, correct, and non-discrimination.
              </p>
              ...
              <p className="text-sm text-gray-600">
                AlecRae does not carry professional liability insurance for your benefit. If you are an accountant or bookkeeper using AlecRae for client work, maintain your own E&O insurance and exercise independent professional judgement.
              </p>
            </Section>
          </div>
          ...
          <Section title="11. Australia & New Zealand — Supplemental Terms">
            ...
            <div className="mt-3">
              <FeatureTerms title="Tax Agent Services Act (AU)" items={[
                'AlecRae is not a registered tax agent or BAS agent under the Tax Agent Services Act 2009.',
          ...
          <Section title="12. United Kingdom & EU — Supplemental Terms">
            <FeatureTerms title="Consumer Rights" items={[
              ...
              'AlecRae is not FCA-regulated and does not provide regulated financial advice.',
          ...
          <Section title="13. General">
            ...
            <p>
              <strong>Force Majeure:</strong> AlecRae is not liable for failures due to circumstances beyond reasonable control.
            </p>
          </Section>
          ...
          <Section title="14. Contact">
            <p>
              ...
              <br />
              US-specific legal: <span className="text-indigo-600 font-medium">us-legal@alecrae.com</span>
            </p>
          </Section>
        </div>
      </div>
