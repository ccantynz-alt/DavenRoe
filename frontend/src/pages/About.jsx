    ...
    <div className="bg-white text-gray-900 min-h-screen">
      ...
      <section className="py-24 px-6 lg:px-16">
        <div className="max-w-4xl mx-auto text-center">
          <FadeIn>
            <p className="text-sm font-semibold tracking-widest text-indigo-600 uppercase mb-3">About DavenRoe</p>
            ...
            <p className="text-xl text-gray-500 leading-relaxed max-w-3xl mx-auto">
              DavenRoe was built by accountants and engineers who saw the same problem everywhere: brilliant professionals drowning in manual data entry, copy-paste compliance, and repetitive month-end processes. We built the platform we wished existed.
            </p>
          </FadeIn>
        </div>
      </section>
