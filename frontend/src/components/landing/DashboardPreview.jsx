...
/**
 * A floating mockup of the Astra dashboard — built entirely
 * with HTML/CSS to look like a real app screenshot.
 * Tilted with perspective, with floating UI cards around it.
 */
...
export default function DashboardPreview() {
  ...
  return (
    <section className="py-24 px-6 lg:px-16 bg-gradient-to-b from-gray-50 to-white overflow-hidden">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <p className="text-sm font-semibold tracking-widest text-indigo-600 uppercase mb-3">The Platform</p>
        ...
        >
          ...
          >
            ...
            <div className="bg-gray-100 border-b border-gray-200 px-4 py-3 flex items-center gap-3">
              ...
              <div className="flex-1 flex justify-center">
                <div className="bg-white rounded-md px-4 py-1 text-xs text-gray-400 border border-gray-200 min-w-[300px] text-center">
            ...
            <div className="flex">
              {/* Sidebar */}
              <div className="w-56 bg-gray-900 text-white p-4 hidden md:block" style={{ minHeight: 420 }}>
                ...
                <nav className="space-y-1 text-sm">
                  {['Dashboard', 'Clients', 'Transactions', 'Bank Feeds', 'Tax Engine', 'Reports', 'Invoicing', 'Forensics', 'Compliance', 'Ask Astra'].map((item, i) => (
                    <div
                      key={i}
                      className={`px-3 py-2 rounded-lg ${i === 0 ? 'bg-indigo-600/20 text-indigo-300' : 'text-gray-400 hover:text-white'}`}
                    >
                      {item}
                    </div>
                  ))}
              ...
              {/* Main area */}
              <div className="flex-1 p-6 bg-gray-50" style={{ minHeight: 420 }}>
                {/* Top bar */}
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-green-600 font-medium">All systems live</span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-4 gap-3 mb-6">
                  {[
                    ...
                    <div key={i} className="bg-white rounded-xl p-3 border border-gray-100 shadow-sm">
                      ...
                      <div className={`text-[10px] font-medium ${card.up === true ? 'text-green-600' : card.up === false ? 'text-red-600' : 'text-gray-400'}`}>
                        {card.change}
                      </div>
                    </div>
                  ))}
                ...
                {/* Chart area + recent transactions */}
                <div className="grid grid-cols-3 gap-3">
                    ...
                    <div className="flex items-end gap-2 h-32">
                      {[65, 72, 58, 80, 74, 85, 90, 78, 92, 88, 95, 82].map((h, i) => (
                        <div key={i} className="flex-1 flex flex-col gap-0.5">
                          ...
                          <div className="bg-indigo-200 rounded-b" style={{ height: `${h * 0.65}%` }} />
                        </div>
                      ))}
                    </div>
                  ...
                  <div className="bg-white rounded-xl p-4 border border-gray-100 shadow-sm">
                    ...
                    <div className="space-y-3">
                      {[
                        { text: 'BAS Q3 lodged', time: '2m ago', color: 'bg-green-500' },
                        ...
                        { text: 'Bank feed synced', time: '2h ago', color: 'bg-green-500' },
                        { text: 'Monthly close done', time: '3h ago', color: 'bg-purple-500' },
                      ].map((item, i) => (
          ...
          <FloatingCard
            className="-left-12 top-16 hidden lg:block"
            delay={0.3}
            visible={visible}
          >
            <div className="flex items-center gap-2">
          ...
          <FloatingCard
            className="-right-8 top-32 hidden lg:block"
            delay={0.6}
            visible={visible}
          >
            <div className="flex items-center gap-2">
          ...
          <FloatingCard
            className="-right-4 bottom-12 hidden lg:block"
            delay={0.9}
            visible={visible}
          >
            <div className="flex items-center gap-2">
          ...
          <FloatingCard
            className="-left-8 bottom-24 hidden lg:block"
            delay={1.2}
            visible={visible}
          >
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center text-xs font-bold text-blue-600">$</div>
              <div>
...
function FloatingCard({ children, className, delay, visible }) {
  return (
    <div
      className={`absolute z-20 bg-white rounded-xl shadow-lg border border-gray-100 p-3 ${className}`}
      style={{
        opacity: visible ? 1 : 0,
