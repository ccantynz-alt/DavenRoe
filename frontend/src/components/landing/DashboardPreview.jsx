    ...
    <section className="py-28 px-6 lg:px-16 bg-gradient-to-b from-white via-gray-50/50 to-white overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <motion.div
            className="absolute inset-0 -inset-x-10 -bottom-10 rounded-3xl blur-3xl"
            style={{
                  ...
                  {[
                    ...
                    <div
                      ...
                      className={cn(
                        ...
                        item.active ? 'bg-white/10 text-white' : 'text-gray-500'
                      )}
                    >
                      <span>{item.name}</span>
                      {item.badge && (
                        <Badge className="text-[10px] bg-amber-500/20 text-amber-400 px-1.5 py-0.5 border-0">
                          {item.badge}
                        </Badge>
                      )}
                    </div>
              ...
              <div className="flex-1 p-6 bg-gray-50" style={{ minHeight: 440 }}>
                ...
                <div className="grid grid-cols-4 gap-3 mb-5">
                  {[
                    ...
                    <Card key={i} className="rounded-xl p-3 border-gray-100 shadow-none">
                      ...
                      <div className={cn(
                        ...
                        card.up === true ? 'text-emerald-600' : card.up === false ? 'text-red-600' : 'text-gray-400'
                      )}>
                        {card.change}
                      </div>
                    </Card>
                ...
                <div className="grid grid-cols-3 gap-3">
                  <Card className="col-span-2 rounded-xl p-4 border-gray-100 shadow-none">
                  ...
                  <Card className="rounded-xl p-4 border-gray-100 shadow-none">
                    ...
                    <div className="space-y-2.5">
                      {[
                        ...
                        <div key={i} className="flex items-center gap-2">
                          <div className={cn('w-1.5 h-1.5 rounded-full flex-shrink-0', item.color)} />
          ...
          <FloatingCard className="-left-12 top-20 hidden lg:block" delay={0.3}>
          ...
          <FloatingCard className="-right-10 top-36 hidden lg:block" delay={0.6}>
            <div className="flex items-center gap-2.5">
          ...
          <FloatingCard className="-right-6 bottom-16 hidden lg:block" delay={0.9}>
            <div className="flex items-center gap-2.5">
          ...
          <FloatingCard className="-left-10 bottom-28 hidden lg:block" delay={1.2}>
            <div className="flex items-center gap-2.5">
...
function FloatingCard({ children, className, delay }) {
  return (
    <motion.div
      className={cn(
        'absolute z-20 bg-white rounded-xl shadow-lg shadow-gray-200/50 border border-gray-100 p-3.5',
        className
      )}
      initial={{ opacity: 0, y: 20 }}
      whileInView={{ opacity: 1, y: 0 }}
