...
class BusinessChecklist:
    ...
    def get_setup_checklist(self, jurisdiction: str, has_entity: bool = False, has_bank: bool = False,
        ...
        items.append({
            ...
            "priority": 7,
            "why": "Missing a deadline can mean fines. DavenRoe tracks them all for you.",
        })
    ...
    def get_monthly_checklist(self, month: int, jurisdiction: str) -> list[dict]:
        ...
        items = [
            {
                ...
                "description": "Review and approve the transactions DavenRoe has categorized for you",
                "action": "/review",
            ...
            },
            {
                ...
                "description": "Snap photos of receipts before they fade — DavenRoe will OCR and categorize them",
                "action": "/documents",
        ...
        if jurisdiction.upper() == "AU" and month in (10, 1, 4, 7):
            items.append({
                ...
                "description": "Your quarterly BAS is due soon. DavenRoe can prepare it for you.",
                "action": "/tax-filing",
                "action_label": "Prepare BAS",
                "frequency": "quarterly",
                "effort": "15-30 minutes with DavenRoe",
            })
