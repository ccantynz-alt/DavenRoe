...
KNOWLEDGE_BASE: list[dict] = [
    {
        ...
        "content": (
            "DavenRoe supports automatic bank feeds through Plaid (US/CA), Basiq (AU/NZ), "
    ...
    },
    {
        ...
        "content": (
            ...
            "with a secure payment link. DavenRoe supports credit notes, recurring invoices, and "
    ...
    },
    {
        ...
        "content": (
            ...
            "and approve the run. DavenRoe calculates superannuation (AU 11.5%), KiwiSaver (NZ 3-8%), "
    ...
    },
    {
        ...
        "content": (
            ...
            "and superannuation/pension fund details. DavenRoe supports employees across AU, NZ, UK, "
    ...
    },
    {
        ...
        "content": (
            "Go to Tax Filing, select your jurisdiction and period, and DavenRoe will auto-generate "
    ...
    },
    {
        ...
        "content": (
            "DavenRoe includes a cross-border tax treaty engine covering 6 bilateral Double Tax "
    ...
    },
    {
        ...
        "title": "Using Ask DavenRoe (AI assistant)",
        "keywords": ["ai", "astra", "ask", "question", "assistant", "natural language", "nlp"],
        "content": (
            "Ask DavenRoe is your AI financial assistant. Type any question in natural language "
            "such as 'What was my revenue last quarter?' or 'Show me overdue invoices'. DavenRoe "
            "queries your financial data in real time and returns answers with supporting details. "
            "Access it from the Ask DavenRoe page or the command bar (Ctrl+K)."
        ),
    },
    {
        "id": "kb-ai-002",
        ...
        "content": (
            "DavenRoe's AI automatically categorizes bank feed transactions with a confidence score. "
    ...
    },
    {
        ...
        "content": (
            "DavenRoe offers three tiers: Practice ($149/mo) includes all core features and payroll "
    ...
    },
    {
        ...
        "content": (
            "DavenRoe uses AES-256 encryption at rest and TLS 1.3 in transit. All data is stored "
    ...
    },
    {
        ...
        "content": (
            "DavenRoe supports two-factor authentication (2FA) via authenticator apps. Enable it "
    ...
    },
    {
        ...
        "content": (
            "Go to Settings > Data Import to migrate from another platform. DavenRoe supports "
    ...
    },
    {
        ...
        "content": (
            ...
            "fill in your data, and upload. DavenRoe validates the file, shows a preview of the "
    ...
    if not results:
        return {
            ...
            "response": (
                ...
                "our help articles or ask DavenRoe directly using the Ask DavenRoe feature."
            ),
            "sources": [],
            "confidence": 0.0,
        }
