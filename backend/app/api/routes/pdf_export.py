...
<div style="border-bottom:3px solid #4c6ef5;padding-bottom:20px;margin-bottom:30px;">
  ...
  <p style="margin:4px 0 0;color:#6b7280;font-size:13px;">Generated: {datetime.utcnow().strftime('%Y-%m-%d %H:%M UTC')} | DavenRoe Autonomous Accounting</p>
</div>
{rows_html}
{footer_html}
<div style="margin-top:40px;padding-top:16px;border-top:1px solid #e5e7eb;">
  <p style="color:#9ca3af;font-size:10px;">DavenRoe — Autonomous Global Accounting. This document is system-generated. Verify against source records.</p>
</div>
</body></html>"""
...
def _build_text_report(title: str, sections: list[tuple[str, list[tuple[str, str]]]],
    ...
    lines.append("=" * 60)
    lines.append("  DavenRoe — Autonomous Global Accounting")
