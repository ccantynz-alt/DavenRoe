...
async def search_documents(query: str, entity_id: str | None = None):
...
async def link_document(doc_id: str, transaction_id: str):
...
async def store_ocr(doc_id: str, data: dict):
