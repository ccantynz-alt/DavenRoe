...
tools Astra provides for them. This is the master index.

The key insight: every accountant specialization has 2-3 tasks
that eat 60-80% of their time. Automate those, and Astra becomes
...
class AccountingSpecialization:
    """Definition of an accounting specialization and what Astra does for it."""
    id: str
    title: str
    description: str
    certifications: list[str]  # CPA, CA, CMA, etc.
    pain_points: list[str]     # what eats their time
    astra_tools: list[str]     # which Astra tools solve their problems
...
class SpecialistRegistry:
    """Registry of all accounting specializations and their Astra toolkits.
    ...
    def _load_all(self):
        specs = [
            ...
            AccountingSpecialization(
                ...
                astra_tools=["tax_engine", "treaty_engine", "tax_calculator"],
                heavy_lifting=[
            ...
            AccountingSpecialization(
                ...
                astra_tools=["audit_engine", "reconciliation_engine", "sampling_engine"],
                heavy_lifting=[
            ...
            AccountingSpecialization(
                ...
                astra_tools=["variance_engine", "cost_allocation_engine", "forecasting_engine"],
                heavy_lifting=[
            ...
            AccountingSpecialization(
                ...
                astra_tools=["benfords_engine", "anomaly_engine", "vendor_verifier", "money_trail", "due_diligence_agent"],
                heavy_lifting=[
            ...
            AccountingSpecialization(
                ...
                astra_tools=["solvency_engine", "creditor_engine", "voidable_scanner"],
                heavy_lifting=[
            ...
            AccountingSpecialization(
                ...
                astra_tools=["trust_engine", "distribution_engine", "estate_engine"],
                heavy_lifting=[
            ...
            AccountingSpecialization(
                ...
                astra_tools=["grant_engine", "fund_tracker", "nfp_compliance_engine"],
                heavy_lifting=[
            ...
            AccountingSpecialization(
                ...
                astra_tools=["smsf_engine", "pension_engine", "contribution_tracker"],
                heavy_lifting=[
            ...
            AccountingSpecialization(
                ...
                astra_tools=["payroll_engine", "leave_engine", "termination_engine"],
                heavy_lifting=[
            ...
            AccountingSpecialization(
                ...
                astra_tools=["fund_accounting_engine", "budget_engine", "grant_compliance_engine"],
                heavy_lifting=[
            ...
            AccountingSpecialization(
                ...
                astra_tools=["carbon_engine", "esg_engine", "climate_risk_engine"],
                heavy_lifting=[
            ...
            AccountingSpecialization(
                ...
                astra_tools=["forecasting_engine", "benchmark_engine", "scenario_engine"],
                heavy_lifting=[
